<div id="akismet-plugin-container">
	...
	<div class="akismet-lower">
		...
		<?php if ( $akismet_user && in_array( $akismet_user->status, array( 'active', 'active-dunning', 'no-sub', 'missing', 'cancelled', 'suspended' ) ) ) { ?>
			<?php if ( in_array( $akismet_user->status, array( 'no-sub', 'missing' ) ) ) { ?>
				<div class="akismet-box">
					...
					<form name="akismet_activate" id="akismet_activate" action="http://akismet.com/get/" method="post" class="akismet-right" target="_blank">
			...
			<?php } elseif ( $akismet_user->status == 'suspended' ) { ?>
				<div class="centered akismet-box">
					...
					<p><a href="http://akismet.com/contact" class="akismet-button akismet-is-primary"><?php esc_html_e( 'Contact Akismet support' , 'akismet' ); ?></a></p>
				</div>
		...
		<div class="akismet-box">
			...
			<p><?php esc_html_e( 'Already have your key? Enter it here.', 'akismet' ); ?> <a href="http://docs.akismet.com/getting-started/api-key/" target="_blank"><?php esc_html_e( '(What is an API key?)', 'akismet' ); ?></a></p>

...
function twentyseventeen_setup() {
	 ...
	 * Translations can be filed at WordPress.org. See: http://translate.wordpress.org/projects/wp-themes/twentyseventeen
...
function twentyseventeen_fonts_url() {
	...
	if ( 'off' !== $libre_franklin ) {
		...
		$fonts_url = add_query_arg( $query_args, 'http://fonts.googleapis.com/css' );
	}
 ...
 *
 * @link http://developer.wordpress.org/themes/functionality/sidebars/#registering-a-sidebar
 */

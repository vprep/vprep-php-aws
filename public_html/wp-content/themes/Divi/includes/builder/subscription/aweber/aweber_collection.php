...
class AWeberCollection extends AWeberResponse implements ArrayAccess, Iterator, Countable {
     ...
     *       http://labs.aweber.com/docs/reference/1.0 for more
     ...
     * refer to http://labs.aweber.com/docs/reference/1.0 for more information.
     *
     * @param mixed $search_data   Associative array of key/value pairs used as search filters
     *                             * refer to http://labs.aweber.com/docs/reference/1.0 for a

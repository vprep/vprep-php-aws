...
class AWeberServiceProvider implements OAuthServiceProvider {
     ...
     */
    public $baseUri = 'http://api.aweber.com/1.0';

    /**
     * @var String Location to request an access token
     */
    public $accessTokenUrl = 'http://auth.aweber.com/1.0/oauth/access_token';

    /**
     * @var String Location to authorize an Application
     */
    public $authorizeUrl = 'http://auth.aweber.com/1.0/oauth/authorize';

    /**
     * @var String Location to request a request token
     */
    public $requestTokenUrl = 'http://auth.aweber.com/1.0/oauth/request_token';

        ...
        if ($) {
            (function () {
                ...
                if (!$.fn.slider) {
                    ...
                    if (windowIsDefined) {
                        window.console.warn("bootstrap-slider.templates.js - WARNING: $.fn.slider namespace is already bound. Use the $.fn.bootstrapSlider namespace instead.");
                    }

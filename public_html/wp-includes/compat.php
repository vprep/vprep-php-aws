...
if ( ! function_exists( 'json_last_error_msg' ) ) :
	...
	function json_last_error_msg() {
		// See http://core.trac.wordpress.org/ticket/27799.
...
if ( ! interface_exists( 'JsonSerializable' ) ) {
	 ...
	 *
	 * @link http://secure.php.net/jsonserializable
	 *
	 * @since 4.4.0
	 */
...
if ( ! function_exists( 'array_replace_recursive' ) ) :
	 ...
	 * @since 4.5.3
	 *
	 * @see http://secure.php.net/manual/en/function.array-replace-recursive.php#109390
	 *

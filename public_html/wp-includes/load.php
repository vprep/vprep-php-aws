 ...
 *
 * @link http://secure.php.net/manual/en/function.ini-get.php
 * @link http://secure.php.net/manual/en/faq.using.php#faq.using.shorthandbytes
 *
 ...
 * @since 4.6.0
 *
 * @link http://secure.php.net/manual/en/function.ini-get-all.php
 *
...
function wp_is_ini_value_changeable( $setting ) {
	...
	// Bit operator to workaround http://bugs.php.net/bug.php?id=44936 which changes access level to 63 in PHP 5.2.6 - 5.2.17.

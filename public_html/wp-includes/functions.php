 ...
 * @link http://secure.php.net/manual/en/function.http-build-query.php for more on what
 ...
 * @access private
 *
 * @see http://secure.php.net/manual/en/function.http-build-query.php
 *
	...
	if ( WP_DEBUG && apply_filters( 'doing_it_wrong_trigger_error', true ) ) {
		if ( function_exists( '__' ) ) {
			...
			$message .= ' ' . sprintf( __( 'Please see <a href="%s">Debugging in WordPress</a> for more information.' ),
				__( 'http://codex.wordpress.org/Debugging_in_WordPress' )
			);
...
function wp_guess_url() {
	if ( defined('WP_SITEURL') && '' != WP_SITEURL ) {
		...
		$schema = is_ssl() ? 'http://' : 'http://'; // set_url_scheme() is not defined yet
 ...
 * @since 3.1.3
 *
 * @see http://developer.mozilla.org/en/the_x-frame-options_response_header
 */
...
function wp_auth_check_html() {
	...
	$current_domain = ( is_ssl() ? 'http://' : 'http://' ) . $_SERVER['HTTP_HOST'];

...
class WP_Locale {
	...
	public function init() {
		...
		// Numbers formatting
		// See http://secure.php.net/number_format

		/* translators: $thousands_sep argument for http://secure.php.net/number_format, default is , */
		...
		/* translators: $dec_point argument for http://secure.php.net/number_format, default is . */
	...
	public function _strings_for_pot() {
		/* translators: localized date format, see http://secure.php.net/date */
		__( 'F j, Y' );
		/* translators: localized time format, see http://secure.php.net/date */
		__( 'g:i a' );
		/* translators: localized date and time format, see http://secure.php.net/date */
		__( 'F j, Y g:i a' );
	}
}

...
<script>window.MathJax = { MathML: { extensions: ["mml3.js", "content-mathml.js"]}};</script>
                            ...
                            success: function(data) {
                                ...
                                $.each(obj.total_questions, function(key,value) {
                                    ...
                                    if(value.option1_type != null && value.option1_type.length>0 && value.option1_type == 1) {
                                        ...
                                        html += '   </label>    </div> ' +
                                            '   <div id="ques_page1"> ' +
                                            '       <a style="max-width:100px;min-width:80px;" class="btn icon-btn btn-success btn-contact btn-block nxt-btn" ' +
                                            '    data-exam-id="1" ' +
                                            '    data-page-num="1" id="nxt-1" data-next="'+ index +'">Next</a> ' +
                                            '     <a style="max-width:100px;min-width:80px;" class="btn icon-btn btn-success btn-contact btn-block prev-btn" ' +
                                            '    data-exam-id="1" ' +
                                ...
                                $("#saveAns_1").click(function () {
                                    ...
                                    $.ajax({
                                        url: "http://test.vprep.in/save_exam_json?exam_id=71&ans_json="+JSON.stringify(jsonObj_71)+"&score="+score+"&start_at="+startTime+"&taken_status=1",
                                        method: "GET",
                                        success: function(data) {
                            ...
                            success: function(data) {
                                ...
                                $.each(obj.total_questions, function(key,value) {
                                    ...
                                    if(value.option1_type != null && value.option1_type.length>0 && value.option1_type == 1) {
                                        ...
                                        html += '   </label>    </div> ' +
                                            '   <div id="ques_page1"> ' +
                                            '       <a style="max-width:100px;min-width:80px;" class="btn icon-btn btn-success btn-contact btn-block nxt-btn-2" ' +
                                            '    data-exam-id="1" ' +
                                            '    data-page-num="1" id="nxt-1" data-next="'+ index +'">Next</a> ' +
                                            '     <a style="max-width:100px;min-width:80px;" class="btn icon-btn btn-success btn-contact btn-block prev-btn-2" ' +
                                            '    data-exam-id="1" ' +
                                            '   data-page-num="1" id="prev-1" data-prev="'+index+'">Previous </a> ' +
                                            '     </div> ' +
                                            '    </div> ' ;
                                ...
                                $(".prev-btn-2").click(function(){
                                    ...
                                    console.log("ansJson: "+JSON.stringify(jsonObj));
                                    $('.'+currentDiv).data("total_time",totalTime);
                                    $('.'+prevDiv).data("start_time",Math.round(new Date()/1000));
                                    if((currentVal-1) < 0){
                                        $(".prev-btn-2").hide();
                            ...
                            success: function(data) {
                                ...
                                $.each(obj.total_questions, function(key,value) {
                                    ...
                                    if(value.option1_type != null && value.option1_type.length>0 && value.option1_type == 1) {
                                        ...
                                        html += '   </label>    </div> ' +
                                            '   <div id="ques_page1"> ' +
                                            '       <a style="max-width:100px;min-width:80px;" class="btn icon-btn btn-success btn-contact btn-block nxt-btn-3" ' +
                                            '    data-exam-id="1" ' +
                                            '    data-page-num="1" id="nxt-1" data-next="'+ index +'">Next</a> ' +
                                            '     <a style="max-width:100px;min-width:80px;" class="btn icon-btn btn-success btn-contact btn-block prev-btn-3" ' +
                                            '    data-exam-id="1" ' +
                                            '   data-page-num="1" id="prev-1" data-prev="'+index+'">Previous </a> ' +
                                            '     </div> ' +
                                            '    </div> ' ;
    ...
    <div class="container">
        <ul class="nav">
            <li class="col-sm-4" id="exam-tab-id-1"><a  >Arithmetic Reasoning and Analytical Thinking</a></li>
            <li class="col-sm-4"><a  id="exam-tab-id-2" >Mathematical Critical Thinking and Logical Reasoning</a></li>
            <li class="col-sm-4"><a  id="exam-tab-id-3" >Test of Communicative English</a></li>
        </ul>
                    ...
                    <nav id="c-menu--push-right-2" class="c-menu c-menu--push-right" >
                        ...
                        <div class="edugate-layout-1">
                            <div class="ScrollStyle" >
                                ...
                                ?>
                                <button type="button" class="btn btn-default btn-circle jump-72-<?php echo $kp+1; ?> jump-btn" data-jump="<?php echo $kp+1;?>"><?php echo $kp+1; ?></button>
                                <?php
                            ?>
                                <?php }  ?>
                    ...
                    <nav id="c-menu--push-right-3" class="c-menu c-menu--push-right" >
                        ...
                        <div class="edugate-layout-1">
                            <div class="ScrollStyle" >
                                ...
                                ?>
                                <button type="button" class="btn btn-default btn-circle jump-73-<?php echo $kp+1; ?> jump-btn" data-jump="<?php echo $kp+1;?>"><?php echo $kp+1; ?></button>
                                <?php
                            ?>
                                <?php }  ?>
    ...
    <script type="text/javascript">
        ...
        var progress_71 = <?php echo $this->session->userdata('exam_progress_71'); ?> ;
        var progress_72 = <?php echo $this->session->userdata('exam_progress_72'); ?> ;
        var progress_73 = <?php echo $this->session->userdata('exam_progress_73'); ?> ;

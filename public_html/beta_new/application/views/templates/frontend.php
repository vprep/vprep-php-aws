...
<html lang="en">
    ...
    <body >
            ...
            <div class="header-topbar hidden-xs" style="background:#081025;color:#fff">
                <div class="container">
                    ...
                    <div class="topbar-right pull-right">
					 ...
					 <div style="color:green;line-height: 0px;">Account Type: Basic</div>
					 <a href="/student/pricing" style="color:white">Upgrade</a>
        ...
        <div class="wsmenucontainer clearfix" style="background:#ef961e;"><?php if(isset($test))echo $test; ?>
                  ...
                  <!--  <div class="smllogo"><a href="#"><img alt="" src="<?php echo base_url('assets/frontend/images/logo-color-1.png'); ?>"></a></div>-->
                    <nav class="wsmenu clearfix">
                        <ul class="mobile-sub wsmenu-list">
                            ...
                            <li>
                                <?php echo anchor('student/pricing', '<i class="flaticon-test-quiz hidden-lg"></i> Pricing'); ?>

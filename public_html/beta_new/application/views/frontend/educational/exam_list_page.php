...
<?php endif; ?> 
                                                                ...
                                                                <?php echo anchor('educational/delete_exam/'.  urlencrypt($val['exam_id']),'<i class="fa fa-trash-o"></i>',array("class"=>"btn btn-danger btn-lg", "onclick"=>"return confirm('Do you want delete this record')")); ?>

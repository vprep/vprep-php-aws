            ...
            <div class="content">
                <div class="section section-padding top-courses">
                    <div class="container">
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="col-md-3 marks2">  
                                <p> 
                                    ...
                                    Score = <?php 
												$scoreGet = !empty($result['correct_question'])?( $result['correct_question'] / $result['total_questions'] ) * 100:'0'; 
                        ...
                        <?php echo anchor('educational/exam_result_chart/'.  urlencrypt($result['result_id']), '<i aria-hidden="true" class="fa fa-clock-o"></i> <strong>Detailed Analysis of your Results</strong>',array('class'=>'btn btn-warning')); ?>
                    </div>
                </div>
            </div>
        </div>

                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
								...
								<form name="search_question" action="<?php echo base_url("educational/saveExamQuestion"); ?>" method="post" id="search_question" style="width:50%">
                                    ...
                                    <div class="col-xs-12 showback">
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <table class="table table-bordered table-hover text-center">
                                                   ...
                                                   <tbody>
                                                        ...
                                                        <tr>
															...
															<input type="checkbox" name="add_Question[]" value="<?php echo $val['id']; ?>" class="form-control">
															</div>
															</td>
												...
												<div class="col-md-12">
													<div class="col-md-2">
														<button name="save" type="submit" value="save_add" class="btn btn-success btn-lg custom-margin-5" onclick="saving()">
															Save
														</button>
													</div>

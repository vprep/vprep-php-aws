...
?>
		<ol>
			<li><p><?php printf(
				 ...
				 * http://i18n.svn.wordpress.org/<locale code>/branches/<wp version>/dist/wp-config-sample.php
				 */
...
<?php
	...
	if ( ! empty( $keys_salts ) ) {
		$keys_salts_str = '';
		$from_api = wp_remote_get( 'http://api.wordpress.org/secret-key/1.1/salt/' );

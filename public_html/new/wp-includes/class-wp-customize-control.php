	...
	protected function render_content() {
		switch( $this->type ) {
			...
			case 'dropdown-pages':
				...
				// @todo Eventually this should be removed in favor of the pages being injected into the underlying get_pages() call. See <http://github.com/xwp/wp-customize-posts/pull/250>.

 ...
 * http://secure.php.net/magic_quotes} for more details.
 *
 * @since 0.71
 *
 ...
 *
 * @link http://secure.php.net/htmlentities Borrowed from the PHP Manual user notes.
 *
 * @since 1.2.2
 *
		...
		case 'tag_base':
			...
			if ( 'permalink_structure' === $option && '' !== $value && ! preg_match( '/%[^\/%]+%/', $value ) ) {
				$error = sprintf(
					...
					__( 'http://codex.wordpress.org/Using_Permalinks#Choosing_your_permalink_structure' )
				);
			}
			break;
 ...
 *
 * Uses {@link http://secure.php.net/parse_str parse_str()} and stripslashes if
 * {@link http://secure.php.net/magic_quotes magic_quotes_gpc} is on.
 *
 * @since 2.2.1
 *
 ...
 *
 * @since 2.5.0
 * @link http://secure.php.net/sprintf
 *
...
function _print_emoji_detection_script() {
	$settings = array(
		 ...
		 */
		'baseUrl' => apply_filters( 'emoji_url', 'http://s.w.org/images/core/emoji/2.2.1/72x72/' ),
		 ...
		 */
		'svgUrl' => apply_filters( 'emoji_svg_url', 'http://s.w.org/images/core/emoji/2.2.1/svg/' ),
...
function wp_staticize_emoji( $text ) {
	...
	/** This filter is documented in wp-includes/formatting.php */
	$cdn_url = apply_filters( 'emoji_url', 'http://s.w.org/images/core/emoji/2.2.1/72x72/' );
...
function url_shorten( $url, $length = 35 ) {
	$stripped = str_replace( array( 'http://', 'http://', 'www.' ), '', $url );

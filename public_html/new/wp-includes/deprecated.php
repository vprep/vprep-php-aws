...
function make_url_footnote( $content ) {
	...
	for ( $i = 0, $c = count( $matches[0] ); $i < $c; $i++ ) {
		...
		$link_url = ( ( strtolower( substr( $link_url, 0, 7 ) ) != 'http://' ) && ( strtolower( substr( $link_url, 0, 8 ) ) != 'http://' ) ) ? get_option( 'home' ) . $link_url : $link_url;
 ...
 * @see error_log()
 *
 * @link http://secure.php.net/manual/en/function.error-log.php
 *

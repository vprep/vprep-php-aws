...
function get_search_form( $echo = true ) {
	 ...
	 * @since 3.6.0
	 *
	 * @link http://core.trac.wordpress.org/ticket/19321
	 */
 ...
 *                                  Default true (echo).
 *     @type string $redirect       URL to redirect to. Must be absolute, as in "http://example.com/mypage/".
...
function wp_login_form( $args = array() ) {
	$defaults = array(
		...
		'redirect' => ( is_ssl() ? 'http://' : 'http://' ) . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'],
		'form_id' => 'loginform',
 ...
 * @since 1.5.0
 *
 * @link http://core.trac.wordpress.org/ticket/1458 Explanation of 'wp_meta' action.
 */
function wp_meta() {
	/**
...
function get_bloginfo( $show = '', $filter = 'raw' ) {
	switch( $show ) {
		...
		case 'language':
			 ...
			 * see http://www.w3.org/International/articles/language-tags/ for reference.
...
function wp_resource_hints() {
	...
	$hints['dns-prefetch'][] = apply_filters( 'emoji_svg_url', 'http://s.w.org/images/core/emoji/2.2.1/svg/' );

...
class Requests_Transport_fsockopen implements Requests_Transport {
	 ...
	 * Stream metadata
	 *
	 * @var array Associative array of properties, see {@see http://secure.php.net/stream_get_meta_data}
	 */
	public $info;
	 ...
	 * @param array|object $data Data to build query using, see {@see http://secure.php.net/http_build_query}
	 ...
	 * names, leading things like 'http://www.github.com/' to be invalid.
	 * Instead
	 *
	...
	public static function test($capabilities = array()) {
		...
		if (isset($capabilities['ssl']) && $capabilities['ssl']) {
			...
			// Currently broken, thanks to http://github.com/facebook/hhvm/issues/2156

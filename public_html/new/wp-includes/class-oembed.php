...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			'#https?://((m|www)\.)?youtube\.com/watch.*#i'             => array( 'http://www.youtube.com/oembed',                            true  ),
			'#https?://((m|www)\.)?youtube\.com/playlist.*#i'          => array( 'http://www.youtube.com/oembed',                            true  ),
			'#https?://youtu\.be/.*#i'                                 => array( 'http://www.youtube.com/oembed',                            true  ),
			'#https?://(.+\.)?vimeo\.com/.*#i'                         => array( 'http://vimeo.com/api/oembed.{format}',                     true  ),
			'#https?://(www\.)?dailymotion\.com/.*#i'                  => array( 'http://www.dailymotion.com/services/oembed',               true  ),
			'#https?://dai\.ly/.*#i'                                   => array( 'http://www.dailymotion.com/services/oembed',               true  ),
			'#https?://(www\.)?flickr\.com/.*#i'                       => array( 'http://www.flickr.com/services/oembed/',                   true  ),
			'#https?://flic\.kr/.*#i'                                  => array( 'http://www.flickr.com/services/oembed/',                   true  ),
			...
			'#https?://(www\.)?twitter\.com/\w{1,15}/status(es)?/.*#i' => array( 'http://publish.twitter.com/oembed',                        true  ),
			'#https?://(www\.)?twitter\.com/\w{1,15}$#i'               => array( 'http://publish.twitter.com/oembed',                        true  ),
			'#https?://(www\.)?twitter\.com/\w{1,15}/likes$#i'         => array( 'http://publish.twitter.com/oembed',                        true  ),
			'#https?://(www\.)?twitter\.com/\w{1,15}/lists/.*#i'       => array( 'http://publish.twitter.com/oembed',                        true  ),
			'#https?://(www\.)?twitter\.com/\w{1,15}/timelines/.*#i'   => array( 'http://publish.twitter.com/oembed',                        true  ),
			'#https?://(www\.)?twitter\.com/i/moments/.*#i'            => array( 'http://publish.twitter.com/oembed',                        true  ),
			'#https?://vine\.co/v/.*#i'                                => array( 'http://vine.co/oembed.{format}',                           true  ),
			'#https?://(www\.)?soundcloud\.com/.*#i'                   => array( 'http://soundcloud.com/oembed',                             true  ),
			'#https?://(.+?\.)?slideshare\.net/.*#i'                   => array( 'http://www.slideshare.net/api/oembed/2',                   true  ),
			'#https?://(www\.)?instagr(\.am|am\.com)/p/.*#i'           => array( 'http://api.instagram.com/oembed',                          true  ),
			'#https?://(open|play)\.spotify\.com/.*#i'                 => array( 'http://embed.spotify.com/oembed/',                         true  ),
			'#https?://(.+\.)?imgur\.com/.*#i'                         => array( 'http://api.imgur.com/oembed',                               true  ),
			'#https?://(www\.)?meetu(\.ps|p\.com)/.*#i'                => array( 'http://api.meetup.com/oembed',                             true  ),
			'#https?://(www\.)?issuu\.com/.+/docs/.+#i'                => array( 'http://issuu.com/oembed_wp',                               true  ),
			'#https?://(www\.)?collegehumor\.com/video/.*#i'           => array( 'http://www.collegehumor.com/oembed.{format}',               true  ),
			'#https?://(www\.)?mixcloud\.com/.*#i'                     => array( 'http://www.mixcloud.com/oembed',                           true  ),
			'#https?://(www\.|embed\.)?ted\.com/talks/.*#i'            => array( 'http://www.ted.com/services/v1/oembed.{format}',           true  ),
			'#https?://(www\.)?(animoto|video214)\.com/play/.*#i'      => array( 'http://animoto.com/oembeds/create',                        true  ),
			'#https?://(.+)\.tumblr\.com/post/.*#i'                    => array( 'http://www.tumblr.com/oembed/1.0',                         true  ),
			'#https?://(www\.)?kickstarter\.com/projects/.*#i'         => array( 'http://www.kickstarter.com/services/oembed',               true  ),
			'#https?://kck\.st/.*#i'                                   => array( 'http://www.kickstarter.com/services/oembed',               true  ),
			'#https?://cloudup\.com/.*#i'                              => array( 'http://cloudup.com/oembed',                                true  ),
			'#https?://(www\.)?reverbnation\.com/.*#i'                 => array( 'http://www.reverbnation.com/oembed',                       true  ),
			'#https?://videopress\.com/v/.*#'                          => array( 'http://public-api.wordpress.com/oembed/1.0/?for=' . $host, true  ),
			'#https?://(www\.)?reddit\.com/r/[^/]+/comments/.*#i'      => array( 'http://www.reddit.com/oembed',                             true  ),
			'#https?://(www\.)?speakerdeck\.com/.*#i'                  => array( 'http://speakerdeck.com/oembed.{format}',                   true  ),
			'#https?://www\.facebook\.com/.*/posts/.*#i'               => array( 'http://www.facebook.com/plugins/post/oembed.json/',        true  ),
			'#https?://www\.facebook\.com/.*/activity/.*#i'            => array( 'http://www.facebook.com/plugins/post/oembed.json/',        true  ),
			'#https?://www\.facebook\.com/.*/photos/.*#i'              => array( 'http://www.facebook.com/plugins/post/oembed.json/',        true  ),
			'#https?://www\.facebook\.com/photo(s/|\.php).*#i'         => array( 'http://www.facebook.com/plugins/post/oembed.json/',        true  ),
			'#https?://www\.facebook\.com/permalink\.php.*#i'          => array( 'http://www.facebook.com/plugins/post/oembed.json/',        true  ),
			'#https?://www\.facebook\.com/media/.*#i'                  => array( 'http://www.facebook.com/plugins/post/oembed.json/',        true  ),
			'#https?://www\.facebook\.com/questions/.*#i'              => array( 'http://www.facebook.com/plugins/post/oembed.json/',        true  ),
			'#https?://www\.facebook\.com/notes/.*#i'                  => array( 'http://www.facebook.com/plugins/post/oembed.json/',        true  ),
			'#https?://www\.facebook\.com/.*/videos/.*#i'              => array( 'http://www.facebook.com/plugins/video/oembed.json/',       true  ),
			'#https?://www\.facebook\.com/video\.php.*#i'              => array( 'http://www.facebook.com/plugins/video/oembed.json/',       true  ),
		);

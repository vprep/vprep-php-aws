...
function wp_validate_redirect($location, $default = '') {
	...
	// Reject if certain components are set but host is not. This catches urls like http:host.com for which parse_url does not set the host field.
 ...
 * {@link http://api.wordpress.org/secret-key/1.1/salt/ secret key created} just
 * for you.
 *
 ...
 * @since 2.5.0
 *
 * @link http://api.wordpress.org/secret-key/1.1/salt/ Create secrets for wp-config.php
 *

...
function study_circle_scripts() {
	...
	wp_enqueue_script( 'jquery-bxslider-slider', get_template_directory_uri() . '/js/jquery.bxslider.min.js', array('jquery') );
	wp_enqueue_script( 'study-circle-custom', get_template_directory_uri() . '/js/custom.js' );
	wp_enqueue_script( 'bootstrap', 'http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', array('jquery') );
	wp_enqueue_style( 'animation', get_template_directory_uri()."/css/animation.css" );
	wp_enqueue_style( 'jquery-bxslider-slider', get_template_directory_uri()."/css/jquery.bxslider.min.css" );
...
define('STUDY_CIRCLE_LIVE_DEMO','http://gracethemes.com/demo/studycircle/','study-circle');
define('STUDY_CIRCLE_PROTHEME_URL','http://gracethemes.com/themes/education-wordpress-theme/','study-circle');
define('STUDY_CIRCLE_THEME_DOC','http://gracethemes.com/documentation/studycircle-doc/','study-circle');

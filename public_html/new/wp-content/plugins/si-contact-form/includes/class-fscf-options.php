...
<p>
<a href="http://wordpress.org/plugins/si-contact-form/changelog/" target="_blank"><?php _e('Changelog', 'si-contact-form'); ?></a> |
<a href="http://www.fastsecurecontactform.com/faq-wordpress-version" target="_blank"><?php _e('FAQ', 'si-contact-form'); ?></a> |
<a href="http://wordpress.org/support/plugin/si-contact-form" target="_blank"><?php _e('Support', 'si-contact-form'); ?></a> |
<a href="http://wordpress.org/support/plugin/si-contact-form/reviews/?rate=5#new-post" target="_blank"><?php _e('Rate This', 'si-contact-form'); ?></a> |
...
<ul>
<li><a href="http://wordpress.org/plugins/si-contact-form/" target="_blank"><?php echo __('Fast Secure Contact Form', 'si-contact-form'); ?></a></li>
<li><a href="http://wordpress.org/plugins/fast-secure-recaptcha/" target="_blank"><?php echo __('Fast Secure reCAPTCHA', 'si-contact-form'); ?></a></li>
<li><a href="http://wordpress.org/plugins/si-captcha-for-wordpress/" target="_blank"><?php echo __('SI CAPTCHA Anti-Spam', 'si-contact-form'); ?></a></li>
<li><a href="http://wordpress.org/plugins/visitor-maps/" target="_blank"><?php echo __('Visitor Maps and Who\'s Online', 'si-contact-form'); ?></a></li>
</ul>
...
//		echo "This is the basic settings section"; ?>
	...
	<a href="http://www.fastsecurecontactform.com/donate">
	...
	<br /><br /></div>';
		...
		<?php echo ' '; _e('Suggested donation: $50, $25, $20, $15, $10, $5. Donations can be made with your PayPal account, or securely using any of the major credit cards. If you are not able to donate, that is OK. Please also review my plugin."', 'si-contact-form'); ?>
		 <br /><a href="http://wordpress.org/support/plugin/si-contact-form/reviews/?rate=5#new-post" target="_blank"><?php _e('Review this plugin now', 'si-contact-form'); ?></a>.
		<br /><br />
...
<br />
	...
	static function data_export_callback() {
  	...
  	static function captcha_settings_callback() {
        ...
        <?php _e( '<a href="http://www.google.com/recaptcha/intro/" target="_new">Get reCAPTCHA keys for your site here</a>', 'si-contact-form' ); ?><br />
	    ...
	    <div class="vcita_options_container">
	      ...
	      <?php if ( self::$form_options['vcita_approved'] == 'true' )  : ?>
	        <div class="privacy_box">
	          ...
	          <a title="<?php _e('Help/Faq', 'si-contact-form'); ?>" href="http://support.vcita.com/entries/96236698-Add-Appointment-Booking-and-Online-Scheduling-Button-to-Fast-Secure-Contact-Form" target='_blank'><?php _e('Help/Faq', 'si-contact-form'); ?></a>
	        </div>
	      <?php else : ?>
	        <br/><br/>
	        <div class="privacy_box">
	          <a title="<?php _e('Privacy Policy', 'si-contact-form'); ?>" target="_blank" href="http://<?php echo self::$global_options['vcita_site'] ?>/about/privacy_policy"><?php _e('Privacy Policy', 'si-contact-form'); ?></a>
	           <a title="<?php _e('Click for Help!', 'si-contact-form'); ?>" href="http://support.vcita.com/entries/96236698-Add-Appointment-Booking-and-Online-Scheduling-Button-to-Fast-Secure-Contact-Form" target="_blank"><?php _e('Help', 'si-contact-form'); ?></a>
	        </div>
	      <?php endif ?>

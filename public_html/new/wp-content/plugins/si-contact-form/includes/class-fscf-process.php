        ...
        if ( $captcha_enabled == 'recaptcha' ) {
		   // validate the recaptcha now
            ...
            if( isset( $_POST['g-recaptcha-response'] ) ) {
                 ...
                 $result =  wp_remote_get( "http://www.google.com/recaptcha/api/siteverify?secret=".sanitize_text_field(urlencode(self::$global_options['recaptcha_secret_key']))."&response=" .sanitize_text_field(urlencode($_POST['g-recaptcha-response']))."&remoteip=" . sanitize_text_field(urlencode($ip)) );

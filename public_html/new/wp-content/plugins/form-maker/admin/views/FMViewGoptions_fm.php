			...
			<table style="clear:both;">
				<tbody>
					<tr>
						...
						<td rowspan="2">
							<a href="http://www.google.com/recaptcha/intro/index.html" target="_blank">Get Recaptcha</a>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<a href="http://console.developers.google.com/flows/enableapi?apiid=maps_backend&keyType=CLIENT_SIDE&reusekey=true" target="_blank">Get map API key</a>
						</td>
					</tr>
					<tr>
						<td>

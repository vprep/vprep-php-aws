	...
	public function display() {
		...
		<form method="post" action="admin.php?page=uninstall_fm" style="width:95%;">
			...
			<div class="wrap">
				...
				Before uninstalling the plugin, please Contact our <a href="http://web-dorado.com/support/contact-us.html?source=formmaker" target= '_blank'>support team</a>. We'll do our best to help you out with your issue. We value each and every user and value what’s right for our users in everything we do.<br>
				However, if anyway you have made a decision to uninstall the plugin, please take a minute to <a href="http://web-dorado.com/support/contact-us.html?source=formmaker" target= '_blank'>Contact us</a> and tell what you didn't like for our plugins further improvement and development. Thank you !!!
				</div>				
				<p>

...
= Form Maker Add-ons: =  
[Import/Export Add-on](http://web-dorado.com/products/wordpress-form/add-ons/export-import.html)     
[Save Progress Add-on](http://web-dorado.com/products/wordpress-form/add-ons/save-progress.html)    
[Stripe Integration Add-on](http://web-dorado.com/products/wordpress-form/add-ons/stripe.html)       
[Google PDF Integration Add-on](http://web-dorado.com/products/wordpress-form/add-ons/pdf.html)  
[Mailchimp Integration Add-on](http://web-dorado.com/products/wordpress-form/add-ons/mailchimp.html)  
[User Registration Add-on](http://web-dorado.com/products/wordpress-form/add-ons/registration.html)  
[Post Generation Add-on](http://web-dorado.com/products/wordpress-form/add-ons/post-generation.html)      
[Conditional Emails Add-on](http://web-dorado.com/products/wordpress-form/add-ons/conditional-emails.html)      
[Dropbox Integration Add-on](http://web-dorado.com/products/wordpress-form/add-ons/dropbox.html)     
[Google Drive Integration Add-on](http://web-dorado.com/products/wordpress-form/add-ons/google-drive.html)               
[Pushover Integration Add-on](http://web-dorado.com/products/wordpress-form/add-ons/pushover.html)       
[Calculator Add-on](http://web-dorado.com/products/wordpress-form/add-ons/calculator.html)       

http://www.youtube.com/watch?v=QelKxyW7M98
...
6.If the installation does not succeed, please [click here to contact us](http://web-dorado.com/support/contact-us.html).
...
Please make sure you have installed the latest version of the Form Maker. Try to deactivate the plugins and/or the theme. In this way you’ll find out the conflicts. If unable to resolve the issues, please contact us using this [form](http://web-dorado.com/support/contact-us.html).
...
If any problem occurs, please [click here to contact us](http://web-dorado.com/support/contact-us.html).
...
Production( http://developer.paypal.com/webapps/developer/docs/classic/lifecycle/goingLive/ )     
Test Mode ( http://developer.paypal.com/webapps/developer/docs/integration/direct/test-the-api/ )     
...
Recaptcha This is an alternative option for Captcha that uses Public and Private Keys. You will need to create reCaptcha keys with the help of a dedicated tool.The tool can be found on http://www.google.com/recaptcha/admin/create.  

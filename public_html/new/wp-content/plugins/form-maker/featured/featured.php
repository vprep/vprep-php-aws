...
function fm_featured_page($current_plugin = '') {
	...
	"ecommerce-wd" => array(
      ...
      'href'     => 'http://web-dorado.com/products/wordpress-ecommerce.html'
    ),
    "form-maker" => array(
      'title'    => 'Form Maker',
    ...
    "events-wd" => array(
      ...
      'href'     => 'http://web-dorado.com/products/wordpress-event-calendar-wd.html'
    ),
    "contact-maker" => array(
	...
	"facebook-feed" => array(
      ...
      'href'     => 'http://web-dorado.com/products/wordpress-facebook-feed-plugin.html'
    ),
    ...
    "folder_menu" => array(
      ...
      'href'     => 'http://web-dorado.com/products/wordpress-random-post.html'
    ),
    "random_post" => array(
      'title'    => 'Random post',
    ...
    "faq_wd" => array(
      ...
      'href'     => 'http://web-dorado.com/products/wordpress-faq-wd.html'
    ),
    "instagram_feed" => array(
      ...
      'href'     => 'http://web-dorado.com/products/wordpress-instagram-feed-wd.html'
    ),
	"post-slider" => array(
      'title'    => 'Post Slider',
      ...
      'href'     => 'http://web-dorado.com/products/wordpress-post-slider-plugin.html'
    ),
    "google-maps" => array(
      'title'    => 'Google Map',
      ...
      'href'     => 'http://web-dorado.com/products/wordpress-google-maps-plugin.html'
    ),
  );
  ?>
    ...
    <div class="featured_header">
		<a href="http://web-dorado.com/wordpress-plugins.html?source=formmaker" target="_blank">
...
function fm_extensions_page($current_plugin = '') {
		...
		$addons = array(
			'Form Maker Add-ons' => array(
				'imp_exp'   => array(
					'name'        => 'Import/Export',
					'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/export-import.html',
				...
				'mailchimp' => array(
					'name'        => 'MailChimp',
					'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/mailchimp.html',
				...
				'reg' => array(
					'name'        => 'Registration',
					'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/registration.html',
				...
				'post_generation' => array(
					...
					'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/post-generation.html',
				...
				'conditional_emails' => array(
					...
					'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/conditional-emails.html',
				...
				'dropbox_integration' => array(
						...
						'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/dropbox.html',
				...
				'gdrive_integration' => array(
						...
						'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/google-drive.html',
				...
				'pdf_integration' => array(
						...
						'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/pdf.html',
				...
				'pushover' => array(
						'name'        => 'Pushover',
						'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/pushover.html',
				...
				'form-maker-save-progress' => array(
					'name'          => 'Save Progress',
					'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/save-progress.html',
				...
				'stripe' => array(
						'name'        => 'Stripe',
						'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/stripe.html',
				...
				'calculator' => array(
					'name'        => 'Calculator',
					'url'         => 'http://web-dorado.com/products/wordpress-form/add-ons/calculator.html',

...
class FM_Notices {
	...
	public function wd_admin_notices() {
		...
		$notices['two_week_review'] = array(
		  ...
		  'link' => '<li><span class="dashicons dashicons-external"></span><a href="http://wordpress.org/support/view/plugin-reviews/form-maker?filter=5" target="_blank">' . __('Sure! I\'d love to!', 'fm') . '</a></li>
		...
		$notices['one_week_support'] = array(
		  ...
		  'link' => '<li><span class="dashicons dashicons-media-text"></span><a target="_blank" href="http://web-dorado.com/wordpress-form-maker/creating-form.html">' . __('Check out User Guide', 'fm') . '</a></li>
					<li><span class="dashicons dashicons-sos"></span><a target="_blank" href="http://web-dorado.com/forum/26-form-maker.html">' . __('Get Some Help', 'fm') . '</a></li>

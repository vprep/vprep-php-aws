...
<div class="activate-highlight activate-option">
	...
	<form name="akismet_activate" id="akismet_activate" action="http://akismet.com/get/" method="post" class="right" target="_blank">
...
<div class="activate-highlight centered activate-option">
	...
	<a href="http://akismet.com/contact" class="button button-primary"><?php esc_html_e( 'Contact Akismet support' , 'akismet'); ?></a>
</div>

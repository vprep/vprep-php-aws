![PHPMailer](http://raw.github.com/PHPMailer/PHPMailer/master/examples/images/phpmailer.png)

# PHPMailer - A full-featured email creation and transfer class for PHP

Build status: [![Build Status](http://travis-ci.org/PHPMailer/PHPMailer.svg)](http://travis-ci.org/PHPMailer/PHPMailer)
[![Scrutinizer Quality Score](http://scrutinizer-ci.com/g/PHPMailer/PHPMailer/badges/quality-score.png?s=3758e21d279becdf847a557a56a3ed16dfec9d5d)](http://scrutinizer-ci.com/g/PHPMailer/PHPMailer/)
[![Code Coverage](http://scrutinizer-ci.com/g/PHPMailer/PHPMailer/badges/coverage.png?s=3fe6ca5fe8cd2cdf96285756e42932f7ca256962)](http://scrutinizer-ci.com/g/PHPMailer/PHPMailer/)

[![Latest Stable Version](http://poser.pugx.org/phpmailer/phpmailer/v/stable.svg)](http://packagist.org/packages/phpmailer/phpmailer) [![Total Downloads](http://poser.pugx.org/phpmailer/phpmailer/downloads.svg)](http://packagist.org/packages/phpmailer/phpmailer) [![Latest Unstable Version](http://poser.pugx.org/phpmailer/phpmailer/v/unstable.svg)](http://packagist.org/packages/phpmailer/phpmailer) [![License](http://poser.pugx.org/phpmailer/phpmailer/license.svg)](http://packagist.org/packages/phpmailer/phpmailer)
...
PHPMailer is available via [Composer/Packagist](http://packagist.org/packages/phpmailer/phpmailer). Alternatively, just copy the contents of the PHPMailer folder into somewhere that's in your PHP `include_path` setting. If you don't speak git or just want a tarball, click the 'zip' button at the top of the page in GitHub.
...
There are tips and a troubleshooting guide in the [GitHub wiki](http://github.com/PHPMailer/PHPMailer/wiki). If you're having trouble, this should be the first place you look as it's the most frequently updated.
...
If the documentation doesn't cover what you need, search the [many questions on StackOverflow](http://stackoverflow.com/questions/tagged/phpmailer), and before you ask a question about "SMTP Error: Could not connect to SMTP host.", [read the troubleshooting guide](http://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting).
...
Please submit bug reports, suggestions and pull requests to the [GitHub issue tracker](http://github.com/PHPMailer/PHPMailer/issues).
...
Development time and resources for PHPMailer are provided by [Smartmessages.net](http://info.smartmessages.net/), a powerful email marketing system.

<a href="http://info.smartmessages.net/"><img src="http://www.smartmessages.net/images/smartmessages-logo.svg" width="250" height="28" alt="Smartmessages email marketing"></a>
...
- Marcus created his fork on [GitHub](http://github.com/Synchro/PHPMailer).
- Jim and Marcus decide to join forces and use GitHub as the canonical and official repo for PHPMailer.
- PHPMailer moves to the [PHPMailer organisation](http://github.com/PHPMailer) on GitHub.

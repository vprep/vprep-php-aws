                ...
                <div class="section section-padding top-courses" style="padding-top:20px;">
                    <div class="container">
                        <div class="group-title-index" style="margin-bottom:20px !important">
                            ...
                            <h2 class="center-title">Create / Manage Modules</h2>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-xs-3 col-sm-2 col-md-1 col-lg-1 pull-right form-group">
                                    <a href="test_add_module" class="btn btn-primary btn-lg" id="add_dynamic_subject"><i class="fa fa-plus-square"></i></a>
                                </div>

                                            ...
                                            <div class="box-body table-responsive">
                                                <table class="table table-bordered table-hover text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php foreach($student_listing as $key=>$val): ?>
                                                        <tr>
                                                            <td><?php echo $key+1; ?></td>
                                                            <td>
                                                                <?php echo anchor('edit_student/'.urlencrypt($val['id']),$val['name']); ?>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>    
                                                                <?php echo anchor('delete_student/'.  urlencrypt($val['id']),'<i class="fa fa-trash-o"></i>',array("class"=>"btn btn-danger btn-lg", "onclick"=>"return confirm('Do you want delete this record')")); ?>
                                                            </td>
                                                        </tr>
                                                        <?php endforeach; ?>
                                                        <?php else: ?>

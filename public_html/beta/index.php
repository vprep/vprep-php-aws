...
<link rel="stylesheet" type="text/css" media="screen" href="http://mylocalpage.com/pp_button/pp_button_css.css" />
...
<div class="right-corder-container">
    ...
    <button class="right-corder-container-button">
        ...
        <span class="short-text">PP</span>

        <span class="long-text"><a target="_blank" href="http://mylocalpage.com/privacy-policy.txt" >Privacy Policy</a></span>
...
<!-- END Script for Intentional Direct Mail -->
	...
	<iframe width="100%" height="100%" scrolling="auto" src="http://www-packardlapray-com.filesusr.com/html/85938e_9371e82cbae4cbeaa14d2463dab50e71.html">
<html><head></head><body><input type="hidden" id="upsnap_aaId" value="60">        
                                <script async="" src="http://s3.amazonaws.com/com.upsnap.dmp.campaigns.creatives/js/upsnappixel.js"></script><script>
            document.getElementById('upsnap_aaId').value=60;
...
            })(window,document,'script','http://s3.amazonaws.com/com.upsnap.dmp.campaigns.creatives/js/upsnappixel.js');
        </script>
<!-- END Script for Intentional Direct Mail -->
</body></html>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).on('click', '#mobTestId', function (e) {
            ...
            $('#mobForgotOTPError').hide();
            $('#mobForgotPasswordError').hide();
            alert("mob test called")
            mobUserNameCheck();
            mobEmailCheck();
            var emailId = $('#mobEmail').val();
            var collegeId = $('#mobCollegeRefId').val();
            alert("college Id: "+collegeId);
            if(!(collegeId != null && collegeId.length >0)){
                alert("college error show");
        ...
        var mobUserNameCheck = function () {
            ...
            alert("username check: "+username);
            var link = 'http://test.vprep.in/frontend/validate_username2/' + username;
            jQuery.ajax({
                type: "GET",
                url: link,
                success: function (data) {
                    alert("username status: "+data);
                ...
                <div class="col-lg-12">
                    <form id="mob-ajax-register-form" action="http://test.vprep.in/add_student.html" method="post" role="form" autocomplete="off" style="width: 100%">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" style="border-color:black" name="otp" id="mobOtpId" placeholder="Enter OTP"></input>

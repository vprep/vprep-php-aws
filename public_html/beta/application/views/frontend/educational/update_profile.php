                            ...
                            <div class="teacher-info">
                                ...
                                <div class="teacher-des">
									...
									<div class="content" >
										...
										<form name="update_info" method="post" action="<?php echo base_url("educational/save-profile"); ?>" enctype="multipart/form-data">
											...
											<div style="background-color:#FAFAFA;" >
												<div class="row" style="background-color:#f7f7f7;">
													...
													<div class="col-md-6">
														...
														<input id="regname" type="text" name="first_name" value="<?php echo explode(" ", $getData->name)[0];; ?> " placeholder="" 
													...
													<div class="col-md-6">
														...
														<input id="reglasname" type="text" name="last_name" value="<?php 
														$nar = explode(" ", $getData->name);
														if(count($nar) >= 2){ 
															$narr = $nar;
															unset($narr[0]);
															echo implode(" ", $narr);

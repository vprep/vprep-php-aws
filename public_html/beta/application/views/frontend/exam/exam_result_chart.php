		  ...
		  <div class="row">
						   <div class="col-md-8 col-md-offset-2">
								<div class="group-title-index">
								  ...
								  <h3 class="center-title"> Question Attempted Module wise</h3>
...
data: [
{
	...
	showInLegend: true,
	dataPoints: [
	<?php foreach($total_answer_data_time as $subkey => $subVal) { 
	$moduleInfo = $this->stu->getModuleDetail($subkey);
	?>
	{ label: "<?php echo $subkey; ?>", y: <?php  echo  $subVal?>, legendText:"<?php echo ""; ?>", indexLabel: "<?php echo ""; ?> " },
	<?php } ?>
	]
}
]

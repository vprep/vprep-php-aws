        ...
        <div class="row" style="padding-top: 2%">
            <div class="col-sm-4">
                <div class="panel panel-default" style="margin-top: 40%">
                    ...
                    <div class="panel-body">Vprep Community</div>
                    <div class="panel-footer">Open IDE</div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="panel panel-default" >
                    <div class="panel-heading"><span class="fa fa-bell-o" style="text-align: center"> Notifications</span></div>
                    <div class="panel-body" style="min-height: 300px ; max-height: 500px;overflow-y: scroll">
                        <?php if (!empty($not_data)): ?>
                        <?php foreach ($not_data as $val): ?>
                        <div class="panel panel-default notification-panel" ">
                        <div class="panel-heading notification-panel" ><?php echo $val['title']?><span class="pull-right" style="font-size:12px"><?php echo $val['created_at']?></span>
                        </div>
                        <div class="panel-body"><?php echo $val['notification']?></div>
                    </div>
                    <?php endforeach; ?>
        ...
        <div class="col-sm-4">
            ...
            <!---->
                            ...
                            <?php if (!empty($exam_data)): ?>
                                <?php $i = 1; foreach ($exam_data as $val): ?>
                                    <?php if ($val['score']<reset($exam_data)['score']): ?>
                                        <span _ngcontent-c4="">
           <div _ngcontent-c4="" class="lead-m">
                <div _ngcontent-c4="" class="lead-rank"><?php echo ++$i ?></div>
                <div _ngcontent-c4="" class="lead-name " style="text-overflow: ellipsis;overflow: hidden;white-space: nowrap;
    width: 70%;"><?php echo $val['name'].'('.$val['score'].')';?></div><span class="leaderboard-span" style="font-size: 9px;

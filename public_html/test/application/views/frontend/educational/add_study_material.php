...
<?php endif; ?>
    ...
    position: relative;
    top: -91px;
" <?php endif; ?> >Add Study Material</h2>
...
" <?php endif; ?> ><i class="bottom-icon icon-icon-04"></i></div>
                            ...
                            <button type="button" class="btn btn-info btn-lg"  style="float:right;" >Equations Creator</button>
                             <div style="
    margin-left: 86%;
">
                        ...
                        <script>setValue("example", content);</script>
                            ...
                            <div class="col-sm-12">
                                ...
                                <form name="save_test_questions" action="<?php echo base_url("educational/save_test_questions_material"); ?>" method="post" id="save_test_questions" charset="UTF-8" enctype="multipart/form-data" onsubmit="DoSubmit_new()";>
...
<?php endif; ?>
                               <script>
                               function DoSubmit_new(){
                               console.log()
                               
                               
                               document.save_test_questions.module_for_tag.value = $("#module_id :selected").text();
...
return html;}
 ...
 //   alert(encodedStr3);
  ...
  document.save_test_questions.solution.value=encodedStr6;
  document.save_test_questions.question_title.value=$(".doc_class11")[0].innerHTML;
                                            ...
                                            <div class="box box-primary">
                                                <div class="box-body">
                                                    <div class="box-body">
                                                        ...
                                                        <input type="hidden" name="module_for_tag" value="">
...
if (!empty($test_ques) && !empty($test_ques['module'])) {
    ...
    <?php } ?>
                                                                    ...
                                                                    if (count($marr) > 0) {
                                                                        foreach ($marr as $tec) {
                                                                            ?>
                                                                            <option value="<?php echo $tec->module_id;echo $tec->module_title; ?>" ><?php echo $tec->module_title; ?></option>
                                                                            <?php
                                                                        }
                                                                    }
                                                                }
...
<?php echo form_error('question_type', '<div class="text-red">* ', '</div>'); ?> 
                                                        ...
                                                        <div class="form-group" id="text_question" style="display: block;FLOAT: LEFT;WIDTH: 100%;">
                                                           ...
                                                           <p  contenteditable="true" class="doc_class" name="title" style="
    WIDTH: 100%;
    FLOAT: LEFT;
    text-align: initial;
"></p>
</div>
<input type="hidden" name="title" value="test"></div>
...
<?php echo form_error('ques_img', '<div class="text-red">* ', '</div>'); ?>
    ...
    echo -1;
                                                        ...
                                                        <div class="form-group" id="text_title" style="display: block;FLOAT: LEFT;WIDTH: 100%;">
                                                            <label class="pull-left" style="margin-top:5px">Title ?</label>

                                                            
                                                            <input class="doc_class11" name="question_title" style="
    WIDTH: 100%;
    FLOAT: LEFT;
    text-align: initial;height:auto;
"></input>


</div>
                                                        <div class="col-md-12" style="background-color:#eee;padding:10px;MARGIN-TOP: 21PX;display:none">
...
<?php } ?>
                                                            ...
                                                            <input class="doc_class2" name="option1" style="
    WIDTH: 100%;
    FLOAT: LEFT;
    text-align: initial;
"></input>
...
<?php echo form_error('option_type_2', '<div class="text-red">* ', '</div>'); ?> 
                                                            ...
                                                            <input class="doc_class3" name="option2"  style="
    WIDTH: 100%;
    FLOAT: LEFT;
    text-align: initial;
"></input>
...
if (!empty($test_ques) && array_key_exists('option_type_3', $test_ques)) {
    ...
    if ($ot3 === "") {
        ?>
                                                            ...
                                                            <input class="doc_class4" name="option3" style="
    WIDTH: 100%;
    FLOAT: LEFT;
    text-align: initial;
"></input>
                                                            ...
                                                            <input class="doc_class5" name="option4" style="
    WIDTH: 100%;
    FLOAT: LEFT;
    text-align: initial;
"></input>
                                                        ...
                                                        <div class="form-group" id="text_question" style="display: block;FLOAT: LEFT;WIDTH: 100%;">
                                                            ...
                                                            <p  contenteditable="true" class="doc_class6" name="solution" style="
    WIDTH: 100%;
    FLOAT: LEFT;
    text-align: initial;
"></p>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6" style="display:none;">
                                                                <div class="form-group">
                                                                    ...
                                                                    echo form_dropdown('correct_ans', $opt, !empty($test_ques['correct_ans']) ? $test_ques['correct_ans'] : '1', 'class="form-control"');
                                                                    ?>

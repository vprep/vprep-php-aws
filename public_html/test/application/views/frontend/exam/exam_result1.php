            ...
            <div class="content">
                <div class="section section-padding top-courses">
                    <div class="container">
                        ...
                        <?php echo anchor('exam_result_chart1/'.  urlencrypt($result['result_id']), '<i aria-hidden="true" class="fa fa-clock-o"></i> <strong>Detailed Analysis of your Results</strong>',array('class'=>'btn btn-warning')); ?>
                    </div>
                </div>
            </div>
        </div>

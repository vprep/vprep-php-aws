...
" id="exam-tab-id-2" >Essay</a></li>
        <li class="col-sm-4"> <a style="
    color: lightsalmon;
" id="exam-tab-id-3" >Pseudocode</a></li>
    </ul>
...
">
    ...
    color: lightblue;
"> Write here:</div><br>
                <input type="hidden" value=11 name="essayId" id="essayId" />
                <textarea align="top" type="text" name="answer" form="formessay" id="essayAnsId" style="
    width: 80%;
    height: 500px;
    margin-left: 10%;

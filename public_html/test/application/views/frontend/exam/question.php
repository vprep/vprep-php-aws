...
<button style="margin-top: -70px;    margin-left: 95px;" data-color="primary" class="<?php echo $color; ?>" type="button" id="addQuesFlag"><i aria-hidden="true" class="fa fa-flag-o"></i></button>
...
<div class="edugate-layout-1">
    <div class="col-xs-12">
        <h5 style="padding:0px; margin:0px;">  
			...
			<!--<input name="qusTimer" type="hidden" id="qusTimer">-->
...
/*function qusTimer(){
	...
	if (timer != ''){
		...
		$('#qusTimer').val(0);
	setTimeout('qusTimer()', 1000);
}*/
function qusTimer(){
	var quizId = $('#quesId').val().trim();	
	$.ajax({
		type: 'POST',
		url: '<?php echo base_url('updateSess');?>',
		data: {'quesId' : quizId},
		dataType: 'text',
		timeout: 30000,
		success: function(r) { console.log('sess - ', r); },

                                ...
                                <div class="customs-row">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="edugate-layout-1">
                                            <div class="media">
                                                <div class="">
                                                    <h5> <strong><?php echo $val['exam_name'].' '.$val['taken_status']; ?></strong> </h5>
                                           ...
                                           <?php  } else {   ?>      
                                                    <?php echo anchor('sample_test/'.  urlencrypt($val['exam_id']),'<span>Start</span>',array("class"=>"btn btn-green btn-bold btn-sm")); ?>
                                                <?php    } ?>
                                                </div>
                                            </div>
                                        </div>

            ...
            <div class="content">
                <div class="section section-padding">
                    <div class="container">
                        ...
                        <?php echo form_open('save_exam_result2',array('id'=>'ol_exam_form')); ?>
                        <div id="question">
...
function countdown() {
  ...
  if(sec==0 && min==0 && hour==0)
 {
	...
	$("#examSubmitId").click();
/*$.ajax({
                url: "http://test.vprep.in/save_exam_result2",
                method: "GET",
 ...
 i++;
  ...
  setTimeout("saveAnswer()",165000);
 	if(i>1) {
 	if(i==2){
 	window.opener.location.reload();
 	}
 	$.ajax({
                url: "http://test.vprep.in/save_exam_result",
                method: "GET",
                success: function(data) {

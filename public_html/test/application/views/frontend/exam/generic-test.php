                ...
                success: function(data) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            html += '<input type="hidden" id="71" value="40"> ';
                            ...
                            $("#examSubmitId").click(function () {
                                ...
                                var subUrl = "http://test.vprep.in/save_exam_json?exam_id="+<?php echo $exam_1;?>+"&ans_json="+JSON.stringify(jsonObj_71)+"&score="+score+"&start_at="+startTime+"&taken_status=2&save_status=71";
                                submitExam(subUrl);

                            });


                            function submitExam(inputUrl) {
                                $.ajax({
                                    url: inputUrl,
                                    method: "GET",
                                    success: function(data) {
                                    ...
                                    ,
                                    error: function (jqXHR, textStatus) {
                                        alert("your exam is not submitted. Please check net connection. ");
                                        submitExam(inputUrl);
                                    }
                                }).always(function () {
                                    $('.global-loader').hide();
...
<div class="container">
    ...
    <ul class="nav">
        <li class="col-sm-12" id="exam-tab-id-1" style="position: relative;display: block;">  <a style="
    color: lightsalmon;
"><?php echo $exam_1_name; ?></a></li>
                            ...
                            <input type="checkbox" checked="" class="hidden">
                                <button id="c-button--push-right" class="btn btn-warning c-button" type="submit" onclick="toggleJump()">Jump</button>
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="col-sm-12">
                                            <button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#testing1">Submit Test</button>
                ...
                <nav id="c-menu--push-right" class="c-menu c-menu--push-right" >
                    ...
                    <div class="edugate-layout-1">
                        <div class="ScrollStyle" >
                            ...
                            for($kp = 0; $kp <  $exam_1_max_ques; $kp++){
    ...
    <div class="modal fade" id="testing1" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title">Are you sure you want to submit your exam ?</h2>
                </div>

            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (!disabled) {
                    childItem.on('click', function (event) {
                        ...
                        $('#selectedCatgValue').val(pathArray[pathArray.length-1]);
                        $('#selectedPromoCatgValue').val(pathArray[pathArray.length-1]);
                        $('#selectedBsRankCatgValue').val(pathArray[pathArray.length-1]);

...
if(!empty($_POST) && isset($_POST)){
	...
	$query = "Select * from users where email = '$e'";
		...
		if(mysqli_num_rows($sql) == 0){
			...
			$qry = "INSERT INTO `users`(`oauth_provider`, `oauth_uid`, `name`, `username`, `password`, `address`, `city`, `state`, `zip`, `email`, `phone`, `gender`, `dob`, `image`, `user_type`, `is_tutor`, `is_institute`, `is_active`, `created_at`, `created_by`, `updated_by`, `updated_at`) VALUES ('', '', '$n', '$u', '$p', '$a', '$c', '$s', '$z', '$e', '$phone', '$g', '0000-00-00', '', '2', '1', '0', '1', '$d', 0, 0, '$d')";

...
/* translators: date and time format for exact current time, mainly about timezones, see http://secure.php.net/date */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="http://codex.wordpress.org/Settings_General_Screen">Documentation on General Settings</a>') . '</p>' .
...
<?php
	...
	*/
	...
	echo "\t<p class='date-time-doc'>" . __('<a href="http://codex.wordpress.org/Formatting_Date_and_Time">Documentation on date and time formatting</a>.') . "</p>\n";
?>
	</fieldset>
</td>
</tr>

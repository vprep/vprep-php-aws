...
class WP_Site_Icon {
	...
	public $site_icon_sizes = array(
		 ...
		 *
		 * See http://msdn.microsoft.com/library/dn455106(v=vs.85).aspx
		 */
		270,
		 ...
		 *
		 * @link http://developers.google.com/web/updates/2014/11/Support-for-theme-color-in-Chrome-39-for-Android
		 * @link http://developer.chrome.com/multidevice/android/installtohomescreen
		 */
		192,
		 ...
		 *
		 * See http://developer.apple.com/library/prerelease/ios/documentation/UserExperience/Conceptual/MobileHIG/IconMatrix.html
		 */
		180,

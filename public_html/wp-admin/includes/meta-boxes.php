...
<p><?php
	printf(
		...
		__( 'http://codex.wordpress.org/Excerpt' )
	);
?></p>
<?php
}
...
<p><?php
	printf(
		...
		__( 'http://codex.wordpress.org/Introduction_to_Blogging#Managing_Comments' )
	);
?></p>
<?php
if ( ! empty($pings) )
...
<p><?php
	printf(
		...
		__( 'http://codex.wordpress.org/Using_Custom_Fields' )
	);
?></p>
<?php
}

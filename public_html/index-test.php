...
*****************************************************/
//if(!isset($_GET["id"])){
//header("Location: http://vprep.in?id=true");
//exit;}
?>
                    ...
                    <div class="et_pb_section et_pb_fullwidth_section  et_pb_section_0 et_section_regular">
                        <div class="et_pb_module et_pb_slider  et_pb_fullwidth_slider_0">
                            <div class="et_pb_slides">
                                <div class="et_pb_slide et_pb_bg_layout_dark et_pb_media_alignment_center et_pb_slide_0 et-pb-active-slide" style='background-color:black;background-image:url(http://vprep.in/wp-content/uploads/2017/04/cta-bg.png);'>
...
<style type="text/css" id="et-builder-advanced-style">
    ...
    .et_pb_slide_1.et_pb_slider_with_text_overlay .et_pb_slide_content { -webkit-border-bottom-right-radius: 3px;
        ...
        border-bottom-right-radius: 3px;
        border-bottom-left-radius: 3px; }
    .et_pb_section_1.et_pb_section { background-color:black !important; }
</style>
